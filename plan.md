...
**🇷🇺 По-русски** в конце описания — русское издание, перевод, дубляж или разбор, если они есть. Машинный перевод помечен. Без русской версии: видео Karpathy (у одного видео есть только автодубляж YouTube), StatQuest (кроме отдельных видео), Kaggle Learn, PyTorch Tutorials, d2l.ai, HF Diffusion Course и Cookbook, PEFT, TRL и Unsloth, Ollama, llama.cpp и vLLM, CS336, CME296, ComfyUI, W&B и всё по AWS.
...
- <a id="r-nanochat"></a>**🛠 nanochat** — Karpathy. Полный конвейер маленького ChatGPT: токенизатор, pretrain, SFT, оценка, веб-чат. Бесплатно. https://github.com/karpathy/nanochat · 🇷🇺 **По-русски:** разбор на Habr «habrGPT. Обучим LLM 0.5B с нуля на статьях Хабра с помощью nanochat» (2026): https://habr.com/ru/articles/1054710/
